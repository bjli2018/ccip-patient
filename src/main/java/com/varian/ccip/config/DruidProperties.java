...
public class DruidProperties {
    ...
    private String url = "jdbc:mysql://localhost:3306/ccip_patient?autoReconnect=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=CONVERT_TO_NULL&useSSL=false&serverTimezone=UTC";
